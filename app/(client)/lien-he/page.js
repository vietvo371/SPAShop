...
export default function ContactPage() {
  ...
  const contactInfo = [
    { 
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="var(--color-primary)"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>, 
      label: "Địa chỉ", 
      value: settings.address || "02 Phan Long Bằng, Quảng Ngãi" 
    },
    { 
      ...
      label: "Hotline", 
      value: settings.phone || "035 630 8211" 
    },
    { 
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="var(--color-primary)"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8-3.58 8-8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg>, 
      label: "Giờ làm việc", 
      value: settings.openHours || "Thứ 2 - Chủ nhật: 8:00 - 20:00" 
    },
  ];

  if (settings.email) {
    contactInfo.splice(2, 0, {
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="var(--color-primary)"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>,
      label: "Email",
