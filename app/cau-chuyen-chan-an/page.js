      ...
      <section className="page-content">
        <div className="container">
          ...
          <div style={{ marginTop: "60px" }}>
            <h2 style={{ fontSize: "1.8rem", color: "var(--color-primary)", marginBottom: "20px", textAlign: "center" }}>
              Giá Trị Cốt Lõi
            </h2>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "30px", marginTop: "30px" }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <h3 style={{ fontSize: "1.1rem", fontWeight: 700, color: "var(--color-primary)", marginBottom: "12px" }}>{v.title}</h3>
                  <p style={{ fontSize: "0.9rem", color: "var(--color-gray)", lineHeight: 1.7 }}>{v.desc}</p>
                </div>
              ))}
            </div>
          </div>
